...
parser.add_argument(
    "--url_file", type=str,
    default='/home/fzm/_giikin_pro_adrlhf/DeepSpeedExamples/Megatron-LM-data-openwebtxt/OpenWebText/Version1/cleanurls.txt'
)
parser.add_argument(
    "--save_uncompressed",
    action="store_true",
...
parser.add_argument(
    "--output_dir",
    type=str,
    default="/home/fzm/_giikin_pro_adrlhf/DeepSpeedExamples/Megatron-LM-data-openwebtxt/OpenWebText/Version1/downloaddatafromcleanurlst",
...
def download(
    ...
    # text, meta = newspaper(url, memoize)
