...
class webtext(json_dataset):
    ...
    """
    PATH = '/home/fzm/_giikin_pro_adrlhf/DeepSpeedExamples/Megatron-LM-data-openwebtxt/parquet_format_data/urlsf_subset0__.tar/demo001-010-data-txt-2-jsonformat/merged_output.json'
